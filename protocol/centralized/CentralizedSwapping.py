...
class CentralizedSwapping(NodeProtocol):
    ...
    def __init__(self, node, port, role, repeater_mem_posA=None, repeater_mem_posB=None, corrector_mem_pos=None, portout=None, start_expression=None, name=None):
        if role.lower() not in ["repeater", "corrector", "localcontroller"]:
            raise ValueError
    ...
    def run(self):
        ...
        elif self.role == "localcontroller":
            yield from self._run_localcontroller()
